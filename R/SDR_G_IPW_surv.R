...
SDR_G_IPW_surv<-function(
    ...
    ############################################################################
    SDR.output<-SDRreg.SuperLearner(covariates,follow.up.time,pred_event_censor.list,visit.times,tvals,truncation.index,id.var,time.var,event.var,Q.formula,Q.SuperLearner.control,denom.survival.trunc)
    G.output<-Greg.SuperLearner(covariates,follow.up.time,lapply(pred_event_censor.list,function(x) x$event),visit.times,tvals,truncation.index,id.var,time.var,event.var,Q.formula,Q.SuperLearner.control)
    IPW.output<-IPWreg.SuperLearner(covariates,follow.up.time,lapply(pred_event_censor.list,function(x) x$censor),visit.times,tvals,truncation.index,id.var,time.var,event.var,Q.formula,Q.SuperLearner.control,denom.survival.trunc)
